    ...
    return <>
        <KBarPortal>
            <KBarPositioner className='fixed inset-0 bg-black/40 dark:bg-black/60 backdrop-blur-sm scrollbar-hide !p-0 z-[999]'>
                <KBarAnimator className='max-w-[600px] !mt-64 w-full bg-white dark:bg-gray-900 text-foreground dark:text-white shadow-lg border dark:border-black rounded-lg overflow-hidden relative !-translate-y-12'>
                    <div className="bg-white dark:bg-black">
                        <div className="border-x-0 border-b-2 dark:border-gray-700">
                            <KBarSearch className='py-4 px-6 text-lg w-full bg-white dark:bg-black outline-none border-none focus:outline-none focus:ring-0 focus:ring-offset-0' />
                        </div>
                        <ShortcutOptions />
                    </div>
                </KBarAnimator>
